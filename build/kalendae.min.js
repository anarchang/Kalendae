...
endMonth);b==l[g]?e.addClassName(d.header.children[g],c.daySelected):e.removeClassName(d.header.children[g],c.daySelected)}while(++g<l.length)}a.add(1,"months")}while(++h<r);if(q.directionScrolling){d=k().startOf("month").hours(12);a=a.diff(d,"months",!0);if("today-past"===q.direction||"past"===q.direction)0>a?(this.disableNextMonth=!1,e.removeClassName(this.container,c.disableNextMonth)):(this.disableNextMonth=!0,e.addClassName(this.container,c.disableNextMonth));else if("today-future"===q.direction||
